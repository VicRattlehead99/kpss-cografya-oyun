...
const TUM_SORULAR = [
  ...
  { soru: "Manganez Çıkarımı", kategori: "Madenler", iller: ["Zonguldak","Denizli","Trabzon","Rize","Ardahan"] },
  ...
  { soru: "Perlit (İnci Taşı) Çıkarımı (Tarım ve inşaat)", kategori: "Madenler", iller: ["İzmir", "Balıkesir", "Ankara", "Erzurum", "Erzincan", "Kars", "Bitlis", "Van"] },
