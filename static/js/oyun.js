...
const TUM_SORULAR = [
  ...
  { soru: "Tuz Mağarası (Tuz Çıkarımı)", kategori: "Magara", iller: ["Çankırı"] },
  { soru: "Hassa Mağarası (Lav Tüpü)", kategori: "Magara", iller: ["Hatay"] },
  { soru: "Bulak Mencilis Mağarası", kategori: "Magara", iller: ["Karabük"] },
  { soru: "Kaklık Mağarası (İçerisinde Traverten var.)", kategori: "Magara", iller: ["Denizli"] },
  ...
  { soru: "Altınbeşik Mağarası (Yer altı gölüne sahip)", kategori: "Magara", iller: ["Antalya"] },
  ...
  { soru: "İnsuyu Mağarası (Turizme açılan ilk mağara)", kategori: "Magara", iller: ["Burdur"] },
  { soru: "Pınargözü Mağarası", kategori: "Magara", iller: ["Isparta"] },
  { soru: "Ballıca Mağarası (Soğan Sarkıtları)", kategori: "Magara", iller: ["Tokat"] },
  { soru: "Gökgöl Mağarası", kategori: "Magara", iller: ["Zonguldak"] },
  { soru: "Karaca Mağarası", kategori: "Magara", iller: ["Gümüşhane"] },
  { soru: "Buzluk Mağarası", kategori: "Magara", iller: ["Elazığ"] },
  { soru: "Cennet-Cehennem Obrukları", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Peynirlikönü (Morca) Mağarası (Türkiye'nin en derin mağarası)", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Çukurpınar Düdeni", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Gilindire (Aynalıgöl) Mağarası", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Yerköprü Mağarası", kategori: "Magara", iller: ["Konya"] },
  { soru: "Kadıini Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "Tınaztepe Mağarası", kategori: "Magara", iller: ["Konya"] },
  { soru: "Zeus Mağarası", kategori: "Magara", iller: ["Aydın"] },
