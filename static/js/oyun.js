...
const TUM_SORULAR = [
  ...
  { soru: "Düden Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "Altınbeşik Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "Beldibi Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "Çal Mağarası", kategori: "Magara", iller: ["Trabzon"] },
  { soru: "Manastır Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "Astım Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "İnsuyu Mağarası", kategori: "Magara", iller: ["Burdur"] },
  { soru: "Pınargözü Mağarası", kategori: "Magara", iller: ["Isparta"] },
  { soru: "Ballıca Mağarası", kategori: "Magara", iller: ["Tokat"] },
  { soru: "Gökgöl (Saklı Cennet) Mağarası", kategori: "Magara", iller: ["Zonguldak"] },
  { soru: "Saklı Cennet Mağarası", kategori: "Magara", iller: ["Zonguldak"] },
  { soru: "Karaca Mağarası", kategori: "Magara", iller: ["Gümüşhane"] },
  { soru: "Buzluk Mağarası (Ağrı)", kategori: "Magara", iller: ["Ağrı"] },
  { soru: "Cennet-Cehennem Obrukları", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Peynirlikönü Mağarası", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Çukurpınar Düdeni", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Gilindire Mağarası", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Yerköprü Mağarası", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Kadıini Mağarası", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Tınaztepe Mağarası", kategori: "Magara", iller: ["Konya"] },
  { soru: "Dilek Yarımadası (İn) Mağarası", kategori: "Magara", iller: ["Aydın"] },
  { soru: "Zindan Mağarası", kategori: "Magara", iller: ["Konya"] },
  { soru: "Tilkiler Mağarası", kategori: "Magara", iller: ["Antalya"] },
  { soru: "Ayvaini Mağarası", kategori: "Magara", iller: ["Bursa"] },
  { soru: "Suluin Mağarası", kategori: "Magara", iller: ["Bartın"] },
  { soru: "Ilgarini Mağarası", kategori: "Magara", iller: ["Kastamonu"] },
  { soru: "İncirliin Mağarası", kategori: "Magara", iller: ["Muğla"] },
  { soru: "Keloğlan Mağarası", kategori: "Magara", iller: ["Karaman"] },
  { soru: "Eshab-ı Kehf Mağarası", kategori: "Magara", iller: ["Mersin"] },
  { soru: "Yarımburgaz Mağarası", kategori: "Magara", iller: ["İstanbul"] },
  { soru: "Domuzcuoluk Mağarası", kategori: "Magara", iller: ["Kastamonu"] },
  { soru: "Timraş Mağarası", kategori: "Magara", iller: ["Antalya"] },
...
// ŞELALELER
{ soru: "Manavgat Şelalesi", kategori: "Selale", iller: ["Antalya"] },
{ soru: "Düden Şelalesi", kategori: "Selale", iller: ["Antalya"] },
{ soru: "Kurşunlu Şelalesi", kategori: "Selale", iller: ["Antalya"] },
{ soru: "Muradiye Şelalesi", kategori: "Selale", iller: ["Van"] },
{ soru: "Girlevik Şelalesi", kategori: "Selale", iller: ["Erzincan"] },
{ soru: "Tortum Şelalesi", kategori: "Selale", iller: ["Erzurum"] },
{ soru: "Tatlıca Şelalesi", kategori: "Selale", iller: ["Sinop"] },
{ soru: "Kapuzbaşı Şelalesi", kategori: "Selale", iller: ["Kayseri"] },
// --- ÖSYM'NİN SEVDİĞİ EKSTRA KRİTİK ŞELALELER ---
{ soru: "Yerköprü Şelalesi (M)", kategori: "Selale", iller: ["Mersin"] },
{ soru: "Yerköprü Şelalesi (K)", kategori: "Selale", iller: ["Konya"] },
{ soru: "Palovit Şelalesi", kategori: "Selale", iller: ["Rize"] },
{ soru: "Mençuna Şelalesi", kategori: "Selale", iller: ["Artvin"] },
{ soru: "Tomara Şelalesi", kategori: "Selale", iller: ["Gümüşhane"] },
{ soru: "Güzeldere Şelalesi", kategori: "Selale", iller: ["Düzce"] },
{ soru: "Ilıca Şelalesi", kategori: "Selale", iller: ["Kastamonu"] },
...
// --- SINIR KAPILARI ---
{ soru: "İpsala Sınır Kapısı (Yunanistan)", kategori: "SinirKapilari", iller: ["Edirne"] },
{ soru: "Pazarkule Sınır Kapısı (Yunanistan)", kategori: "SinirKapilari", iller: ["Edirne"] },
{ soru: "Uzunköprü (Demiryolu) Sınır Kapısı (Yunanistan)", kategori: "SinirKapilari", iller: ["Edirne"] },
{ soru: "Kapıkule Sınır Kapısı (Bulgaristan)", kategori: "SinirKapilari", iller: ["Edirne"] },
{ soru: "Hamzabeyli Sınır Kapısı (Bulgaristan)", kategori: "SinirKapilari", iller: ["Edirne"] },
{ soru: "Dereköy Sınır Kapısı (Bulgaristan)", kategori: "SinirKapilari", iller: ["Kırklareli"] },
{ soru: "Sarp Sınır Kapısı (Gürcistan)", kategori: "SinirKapilari", iller: ["Artvin"] },
{ soru: "Türkgözü (Pasof) Sınır Kapısı (Gürcistan)", kategori: "SinirKapilari", iller: ["Ardahan"] },
{ soru: "Aktaş (Çıldır) Sınır Kapısı (Gürcistan)", kategori: "SinirKapilari", iller: ["Ardahan"] },
{ soru: "Canbaz (Demiryolu) Sınır Kapısı (Gürcistan)", kategori: "SinirKapilari", iller: ["Ardahan"] },
{ soru: "Alican Sınır Kapısı (Ermenistan)", kategori: "SinirKapilari", iller: ["Iğdır"] },
{ soru: "Akyaka (Demiryolu) Sınır Kapısı (Ermenistan)", kategori: "SinirKapilari", iller: ["Kars"] },
{ soru: "Dilucu Sınır Kapısı (Nahçıvan)", kategori: "SinirKapilari", iller: ["Iğdır"] },
{ soru: "Gürbulak Sınır Kapısı (İran)", kategori: "SinirKapilari", iller: ["Ağrı"] },
{ soru: "Kapıköy Sınır Kapısı (İran)", kategori: "SinirKapilari", iller: ["Van"] },
{ soru: "Esendere Sınır Kapısı (İran)", kategori: "SinirKapilari", iller: ["Hakkâri"] },
{ soru: "Habur Sınır Kapısı (Irak)", kategori: "SinirKapilari", iller: ["Şırnak"] },
{ soru: "Üzümlü Sınır Kapısı (Irak)", kategori: "SinirKapilari", iller: ["Hakkâri"] },
{ soru: "Derecik Sınır Kapısı (Irak)", kategori: "SinirKapilari", iller: ["Hakkâri"] },
{ soru: "Cilvegözü Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Hatay"] },
{ soru: "Zeytin Dalı Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Hatay"] },
{ soru: "Yayladağı Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Hatay"] },
{ soru: "Öncüpınar Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Kilis"] },
{ soru: "Çobanbey Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Kilis"] },
{ soru: "Karkamış Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Gaziantep"] },
{ soru: "Mürşitpınar Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Şanlıurfa"] },
{ soru: "Akçakale Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Şanlıurfa"] },
{ soru: "Ceylanpınar Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Şanlıurfa"] },
{ soru: "Şenyurt Sınır Kapısı (Suriye)", kategori: "SinirKapilari", iller: ["Mardin"] },
...
// --- ANTİK KENTLER ---
  { soru: "Tralleis Antik Kenti (Antik Havuz)", kategori: "AntikKentler", iller: ["Aydın"] },
  { soru: "Hadrianapolis Antik Kenti (Karadeniz'in Zeugması)", kategori: "AntikKentler", iller: ["Karabük"] },
  ...
  { soru: "Xanthos Antik Kenti (Likya Birliği'nin En Önemli Kenti - Nereidler Anıtı)", kategori: "AntikKentler", iller: ["Antalya","Muğla"] },
